...
//     */
//    public AlterStats(Animal attackOwner, String name, float accuracy, Map<StatID, Float> statsToAlter, boolean selfInflicting) {
//        super(attackOwner, name, 0, accuracy, new InflictNoStatus(), selfInflicting);
...
//    }
//
//    public AlterStats(String name, float accuracy, Map<StatID, Float> statsToAlter, boolean selfInflicting){
//        this(null, name, accuracy, statsToAlter, selfInflicting);
//    }
//
//    public AlterStats(String name, Map<StatID, Float> statsToAlter, boolean selfInflicting){
//        this(null, name, 1f, statsToAlter, selfInflicting);
//    }
//
//    @Override
//    public void performAttack(IAnimal target, float attackStat) {
//        if(selfInflicting) target = attackOwner;
//        if(accuracyTest()){
//
//        }
//        else{
